...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Days.time_for_video'
        db.delete_column(u'main_days', 'time_for_video')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Days.time_for_video'
        raise RuntimeError("Cannot reverse this migration. 'Days.time_for_video' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Days.time_for_video'
        db.add_column(u'main_days', 'time_for_video',
