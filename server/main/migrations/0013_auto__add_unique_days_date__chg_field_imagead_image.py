...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Days', fields ['date']
        db.create_unique(u'main_days', ['date'])


        # Changing field 'ImageAd.image'
        db.alter_column(u'main_imagead', 'image', self.gf('filebrowser.fields.FileBrowseField')(max_length=255))

    def backwards(self, orm):
        # Removing unique constraint on 'Days', fields ['date']
        db.delete_unique(u'main_days', ['date'])
