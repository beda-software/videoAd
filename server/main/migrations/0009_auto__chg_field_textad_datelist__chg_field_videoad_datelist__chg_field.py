...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TextAd.datelist'
        db.alter_column(u'main_textad', 'datelist', self.gf('main.fields.DateArrayField')(default=[]))

        # Changing field 'VideoAd.datelist'
        db.alter_column(u'main_videoad', 'datelist', self.gf('main.fields.DateArrayField')(default=[]))

        # Changing field 'ImageAd.datelist'
        db.alter_column(u'main_imagead', 'datelist', self.gf('main.fields.DateArrayField')(default=[]))

    def backwards(self, orm):

        # Changing field 'TextAd.datelist'
        db.alter_column(u'main_textad', 'datelist', self.gf('djorm_pgarray.fields.ArrayField')(dbtype=u'date', null=True))

        # Changing field 'VideoAd.datelist'
        db.alter_column(u'main_videoad', 'datelist', self.gf('djorm_pgarray.fields.ArrayField')(dbtype=u'date', null=True))

        # Changing field 'ImageAd.datelist'
        db.alter_column(u'main_imagead', 'datelist', self.gf('djorm_pgarray.fields.ArrayField')(dbtype=u'date', null=True))
